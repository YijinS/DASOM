package com.dasomcompany.faq.service;
...
import com.dasomcompany.dao.FaqDao;
...
public class FaqServiceImpl implements FaqService {
	...
	public void getList(HttpServletRequest request) {
		//CafeDto 객체 생성 (select 할때 필요한 정보를 담기 위해)
				...
				//전체 row 의 갯수를 읽어온다.
				int totalRow=dao.getCount(dto);  //조건에 맞는 글의 갯수를 읽는 것. 
				//전체 페이지의 갯수 구하기
				int totalPageCount=
				...
				List<FaqDto> list=dao.getList(dto);
